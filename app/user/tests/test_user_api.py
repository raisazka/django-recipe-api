...
class PublicUserApiTests(TestCase):
    ...
    def test_create_existing_user(self):
        """ test create existing user failed """
        payload = {'email': 'raisazka@gmail.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'rais@gmail.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        """ test that credentials is invalid """
    ...
    def test_create_token_no_user(self):
        """ test token not created if token not exist """
